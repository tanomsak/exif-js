(function() {
  ...
  function readThumbnailImage(dataView, tiffStart, firstIFDOffset, bigEnd) {
    ...
    if (debug) console.log(thumbTags);
      ...
      switch (thumbTags["Compression"]) {
        case 6:
          ...
          if (thumbTags.JpegIFOffset && thumbTags.JpegIFByteCount) {
            ...
            var data = new Uint8Array(dataView.buffer, tOffset, tLength);
            thumbTags["blob"] = new Blob([data], {
              type: "image/jpeg"
            });
            ...
            thumbTags["image"] = "data:image/jpeg,%" + hexData.join("%");
          }
          break;
